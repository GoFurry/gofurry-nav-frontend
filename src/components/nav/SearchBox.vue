  ...
  <div class="flex flex-col items-center w-full mt-4 relative">
    ...
    <div class="flex sm:gap-6 gap-4 mb-2">
      <div
          ...
          :class="['cursor-pointer px-3 py-1 rounded text-sm transition-all duration-200', selectedCategory === item
            ? 'bg-orange-400 text-white shadow-md shadow shadow-orange-400/30'
    ...
    <div class="relative w-full max-w-[500px]">
      <input
          ...
          placeholder="搜索站点或内容..."
          class="w-full h-12 px-4 pr-10 rounded-lg border-2 border-black/60 bg-gray-300/60 focus:outline-none focus:border-3 focus:border-black/75"
      />
      ...
      <ul
          ...
          class="fixed bg-white rounded-xl border border-gray-100 max-h-60 overflow-y-auto z-50
    ...
    <!-- 搜索平台 -->
    <div
        class="mt-2 w-full max-w-[400px] md:max-w-[600px] grid grid-cols-4 md:flex flex-wrap gap-2 justify-center"
    >
      <div
...
const categories = computed(() => [
  ...
  t('searchBox.platformCate.tools'),
  t('searchBox.platformCate.survey'),
])
...
const scrollToSelectedItem = () => {
  nextTick(() => {
    const listItems = document.querySelectorAll('ul li:not(:first-child)')
