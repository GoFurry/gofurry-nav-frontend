<template>
  <div class="space-y-6">
    ...
    <div class="bg-white  rounded-xl shadow-sm transition-all hover:shadow-md overflow-hidden">
      <div class="p-5 cursor-pointer flex items-center justify-between" @click="togglePanel('http')">
        <h3 class="font-semibold flex items-center gap-2">
          {{ t('site.siteHttpPanel.httpRecord') }}
        </h3>
      </div>

      <div v-if="panels.http" class="border-t border-gray-100 p-5 pt-4">
        ...
        <div>
          ...
          <div v-if="sections.httpMeta" class="space-y-3 text-sm">
    ...
    <!-- TLS 记录面板 -->
    <div class="bg-white rounded-xl shadow-sm transition-all hover:shadow-md overflow-hidden">
      <div class="p-5 cursor-pointer flex items-center justify-between" @click="togglePanel('tls')">
        <h3 class="font-semibold flex items-center gap-2">
          {{ t('site.siteHttpPanel.tlsRecord') }}
        </h3>
      </div>

      <div v-if="panels.tls" class="border-t border-gray-100 p-5 pt-4">
        <div class="space-y-4 text-sm">
          ...
          <div>
            ...
            <div
                ...
                class="bg-gray-50 rounded-lg p-3 mt-2 space-y-2"
            >
