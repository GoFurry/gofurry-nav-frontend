...
const initPieCharts = () => {
  ...
  // 初始化三个环形图
  const charts = [
    { id: 'bt01', data: props.cityStat.region_map, title: '城市分布' },
    { id: 'bt02', data: props.provinceStat.region_map, title: '省份分布' },
    { id: 'bt03', data: props.countryStat.region_map, title: '国家分布' }
  ]
